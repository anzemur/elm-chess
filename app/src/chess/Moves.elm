            ...
            let
                ...
                willInCheck vector =
                    let
                            ...
                            Board
                                (List.map
                                    (\row ->
                                        List.map
                                            (\square ->
                                                if square.pos == vector.start.pos then
                        ...
                        markedKing =
                            markCheck changedBoard vector.position.figure.color
                    in
                    (searchSquare markedKing
                        (\sqr ->
                            sqr.figure.color
                                ...
                                (\square ->
                                    if
                                        vector.position.pos
                                            == square.pos
                                            && square.pos
                                            /= (searchSquare board (\square -> member ChosenSquare square.highlightType)).pos
                                            && not (willInCheck vector)
                                    then
...
markCheck board color =
    let
        king : Square
        king =
            searchSquare board (\square -> square.figure.figureType == King && square.figure.color == color)
        ...
        isInCheck vector =
            let
                endSquare =
                    searchSquare board (\sqr -> sqr.pos == vector.position.pos)
            in
